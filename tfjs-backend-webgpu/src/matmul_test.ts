...
describeWebGPU('matmul', () => {
  ...
  fit('haha test', async () => {
    ...
    // const y = tf.softmax(tf.tensor4d(a, [1,I,J,K]), 3);
    const y = tf.sum(tf.tensor4d(a, [1, I, J, K]), [3]);

    test_util.expectArraysClose(await y.data(), [
      2278,    6767,    11256,   15745,   20234,   24723,   29212,   33701,
      38190,   42679,   47168,   51657,   56146,   60635,   65124,   69613,
      74102,   78591,   83080,   87569,   92058,   96547,   101036,  105525,
      110014,  114503,  118992,  123481,  127970,  132459,  136948,  141437,
      145926,  150415,  154904,  159393,  163882,  168371,  172860,  177349,
      181838,  186327,  190816,  195305,  199794,  204283,  208772,  213261,
      217750,  222239,  226728,  231217,  235706,  240195,  244684,  249173,
      253662,  258151,  262640,  267129,  271618,  276107,  280596,  285085,
      289574,  294063,  298552,  303041,  307530,  312019,  316508,  320997,
      325486,  329975,  334464,  338953,  343442,  347931,  352420,  356909,
      361398,  365887,  370376,  374865,  379354,  383843,  388332,  392821,
      397310,  401799,  406288,  410777,  415266,  419755,  424244,  428733,
      433222,  437711,  442200,  446689,  451178,  455667,  460156,  464645,
      469134,  473623,  478112,  482601,  487090,  491579,  496068,  500557,
      505046,  509535,  514024,  518513,  523002,  527491,  531980,  536469,
      540958,  545447,  549936,  554425,  558914,  563403,  567892,  572381,
      576870,  581359,  585848,  590337,  594826,  599315,  603804,  608293,
      612782,  617271,  621760,  626249,  630738,  635227,  639716,  644205,
      648694,  653183,  657672,  662161,  666650,  671139,  675628,  680117,
      684606,  689095,  693584,  698073,  702562,  707051,  711540,  716029,
      720518,  725007,  729496,  733985,  738474,  742963,  747452,  751941,
      756430,  760919,  765408,  769897,  774386,  778875,  783364,  787853,
      792342,  796831,  801320,  805809,  810298,  814787,  819276,  823765,
      828254,  832743,  837232,  841721,  846210,  850699,  855188,  859677,
      864166,  868655,  873144,  877633,  882122,  886611,  891100,  895589,
      900078,  904567,  909056,  913545,  918034,  922523,  927012,  931501,
      935990,  940479,  944968,  949457,  953946,  958435,  962924,  967413,
      971902,  976391,  980880,  985369,  989858,  994347,  998836,  1003325,
      1007814, 1012303, 1016792, 1021281, 1025770, 1030259, 1034748, 1039237,
      1043726, 1048215, 1052704, 1057193, 1061682, 1066171, 1070660, 1075149,
      1079638, 1084127, 1088616, 1093105, 1097594, 1102083, 1106572, 1111061,
      1115550, 1120039, 1124528, 1129017, 1133506, 1137995, 1142484, 1146973,
      1151462, 1155951, 1160440, 1164929, 1169418, 1173907, 1178396, 1182885,
      1187374, 1191863, 1196352, 1200841
    ]);
  });
