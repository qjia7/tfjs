...
const BACKEND_FLAGS_MAP = {
  ...
  webgpu:
      ['WEBGPU_IMMEDIATE_EXECUTION_ENABLED', 'WEBGPU_BATCH_DISPATCHING_CALLS']
};
const TUNABLE_FLAG_NAME_MAP = {
  ...
  WEBGPU_IMMEDIATE_EXECUTION_ENABLED: 'immediate mode',
  WEBGPU_BATCH_DISPATCHING_CALLS: 'dispatching batch count'
};
